<x-app-layout>
    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
        <form method="POST" action="{{ route('chirps.update', $chirp) }}" class="bg-white p-6 rounded-2xl shadow-lg border border-gray-200">
            @csrf
            @method('patch')
            <textarea
                name="message"
            ...
            <div class="mt-6 space-x-4">
                ...
                <a href="{{ route('chirps.index') }}" class="text-blue-500 hover:text-blue-600 font-semibold">
                    {{ __('Cancel') }}
                </a>
            </div>
        </form>
